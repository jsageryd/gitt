...
You output will always differ\footnote{`Your output will differ'?} to that which is in the book, if sometimes only slightly, but the output has been provided so that you can follow what is happening at each stage.
